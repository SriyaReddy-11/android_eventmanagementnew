                       ...
                       if(task.isSuccessful()){
                           ...
                           FirebaseDatabase.getInstance().getReference("Customers").child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                               ...
                               public void onComplete(@NonNull Task<Void> task) {
                                   if(task.isSuccessful()){
                                        Toast.makeText(CustomerRegistrationActivity.this,"User Registered Successfull",Toast.LENGTH_LONG).show();
                                        finish();
                                    }else{
                                        Toast.makeText(CustomerRegistrationActivity.this,"Failed to register",Toast.LENGTH_LONG).show();
